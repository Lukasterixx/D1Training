...
**UniFP** (source read 16 September; **installed, launched and retargeted 2026-09-18** — see F-067 to F-070 and [`unifp_go2d1/`](../unifp_go2d1/README.md), which records what the port changes and what is still unvalidated)**:** the released
